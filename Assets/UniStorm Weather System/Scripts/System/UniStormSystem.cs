...
namespace UniStorm
{
    public class UniStormSystem : MonoBehaviour
    {
        ...
        Coroutine ColorCoroutine, CloudHeightCoroutine, RainShaderCoroutine, SnowShaderCoroutine, SunColorCoroutine, CloudProfileCoroutine, CloudShadowIntensityCoroutine, MusicVolumeCoroutine;
        ...
        public Gradient CloudLightColorDefault;
        ...
        public bool UpgradedTo_4_2 = false;
        ...
        void InitializeUniStorm()
        {
            ...
            CloudLightColorDefault.colorKeys = new GradientColorKey[7];
            CloudLightColorDefault.colorKeys = CloudLightColor.colorKeys;
...
#else
            m_StarsMaterial.SetFloat("_LoY", 2000);
            m_StarsMaterial.SetFloat("_HiY", 200);
#endif
...
m_CloudsMaterial.SetFloat("_uCloudsDetailStrength", 0.082f);
        ...
        void UpdateColors()
        {
            ...
            {
                m_CloudDomeMaterial.SetFloat("_uHorizonFadeEnd", m_CloudFadeLevelEnd + CloudyFadeControl.Evaluate(m_TimeFloat * 24) * MostlyCloudyFadeValue);
            }
            ...
            else if (FogType == FogTypeEnum.UnistormFog)
            {
                ...
                m_UniStormAtmosphericFog.SunColor = SunColor.Evaluate(m_TimeFloat);
                ...
                m_CloudDomeMaterial.SetColor("_SunColor", SunColor.Evaluate(m_TimeFloat));
