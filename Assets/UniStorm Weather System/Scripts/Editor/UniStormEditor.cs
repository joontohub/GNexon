...
namespace UniStorm.Utility
{
    ...
    public class UniStormEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!self.UpgradedTo_4_2)
            {
                GUI.backgroundColor = new Color(1f, 1, 0.6f, 0.6f);
                EditorGUILayout.HelpBox("Please update this UniStorm system to be compatible with version 4.2 by pressing the button below. This is required in order to properly use 4.2's new features. Your custom settings" +
                ...
                if (GUILayout.Button("Update to Version 4.2"))
                {
                    Debug.Log("UniStorm System updated to version 4.2");
            ...
            if (TabNumberProp.intValue == 2)
            {
                ...
                if (WeatherFoldoutProp.boolValue)
                {
                    ...
                    {
                        GUI.backgroundColor = new Color(0.8f, 0.8f, 0.8f, 1);
                        EditorGUILayout.LabelField("Unity Fog - Uses Unity's built-in fog.", EditorStyles.helpBox);
                        GUI.backgroundColor = Color.white;
                    }
                    ...
                    EditorGUILayout.PropertyField(FogStormyColorProp,
                        new GUIContent("Fog Color (Stormy)", "A gradient that controls the fog color during precipitation Weather Types (Unless being driven by the Fog Color Override on Weather Types). Each element is a transition into the next time of day."));
                    EditorGUILayout.Space();
